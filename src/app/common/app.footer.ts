        ...
        <h2 class="visibility-hidden">Credentials</h2>
          ...
          <div class="page__container footer__content">            
            <div class="footer__copyright">
              ...
              <a class="link" href="https://github.com/marypershai/css-generator">code source</a>
            </div>
            ...
            <div class="footer__general">
              ...
              <a class="link" href="https://rs.school/js/" target="_blank" rel="noopener noreferrer">
                <img class="rss-logo rss-logo--dark " loading="lazy" decoding="async" src="./rs_school_js.svg" alt="RSSchool logo" width="200" height="70">
              </a>
            </div>
